...
internal enum Asset {
    internal enum AddGoal {
        internal static let btnAddEarth = ImageAsset(name: "btn_add_earth")
        internal static let btnAddMars = ImageAsset(name: "btn_add_mars")
        internal static let btnAddMercury = ImageAsset(name: "btn_add_mercury")
        internal static let btnAddMoon = ImageAsset(name: "btn_add_moon")
        internal static let btnAddVenus = ImageAsset(name: "btn_add_venus")
    }
